 ...
 * factors.
 *
 *         (*) MSI_VALUE is a constant defined in stm32u5xx_hal.h file (default
 * value 4 MHz) but the real value may vary depending on the variations in
 * voltage and temperature.
 *
 *         (**) HSI_VALUE is a constant defined in stm32u5xx_hal.h file (default
 * value 16 MHz) but the real value may vary depending on the variations in
 * voltage and temperature.
 *
 *         (***) HSE_VALUE is a constant defined in stm32u5xx_hal.h file
...
void SystemCoreClockUpdate(void) {
  ...
  case 0x0C: /* PLL used as system clock source */
    ...
    */
    ...
    pllr =
        (((RCC->PLL1DIVR & RCC_PLL1DIVR_PLL1R) >> RCC_PLL1DIVR_PLL1R_Pos) + 1U);
